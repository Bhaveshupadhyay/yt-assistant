          ...
          filteredSessions.map((session) => {
            ...
            return (
              <div
                ...
                className={`cursor-pointer group flex items-center justify-between px-2.5 py-2 rounded-xl text-xs transition-all duration-150 ${
                  isActive
                    ? 'bg-primary/15 text-foreground font-semibold border border-primary/30'
                    : 'text-muted hover:text-foreground hover:bg-surface-secondary border border-transparent'
                }`}
              >
                ...
                <button
                  ...
                  className="cursor-pointer opacity-0 group-hover:opacity-100 p-1 text-muted hover:text-destructive rounded hover:bg-surface transition-all"
