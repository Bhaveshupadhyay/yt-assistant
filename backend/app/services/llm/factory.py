...
def resolve_provider_for_model(model_name: str | ModelName) -> ModelProvider:
    """Determine the provider (Anthropic, OpenAI, Gemini, Ollama) from the model name identifier.
...
def get_llm_client(
    ...
    **kwargs: Any,
    ...
    Args:
        model_name: Identifier for the model (e.g. 'claude-3-5-sonnet', 'gemini-2.0-flash', 'llama3.2', 'gpt-4o').
